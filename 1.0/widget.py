...
class NewsWidget(QtWidgets.QWidget):
    ...
    def btn_init(self):  # 4
        ...
        path_back = os.path.join(PROJECT_ROOT, 'back.png')
        path_forword = os.path.join(PROJECT_ROOT,'forward.png')
        path_refresh = os.path.join(PROJECT_ROOT, 'reload.png')
        path_zoom_in = os.path.join(PROJECT_ROOT, 'zoom_in.png')
        path_zoom_out = os.path.join(PROJECT_ROOT, 'zoom_out.png')
        self.back_btn.setIcon(QIcon(path_back))
        self.forward_btn.setIcon(QIcon(path_forword))
        self.refresh_btn.setIcon(QIcon(path_refresh))
        self.zoom_in_btn.setIcon(QIcon(path_zoom_in))
        self.zoom_out_btn.setIcon(QIcon(path_zoom_out))
